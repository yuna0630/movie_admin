...
public interface MovieMapper  {
    ...
    public List<GenreInfoVO> getGenreALL();
    ...
    public List<MovieInfoVO> selectAllMovieInfo(String keyword, Integer offset, String country);
    ...
    public void deleteMovieStoryImgInfo(Integer seq);
    ...
    public void insertMovieStoryImgInfo(MovieStoryImgVO data);
