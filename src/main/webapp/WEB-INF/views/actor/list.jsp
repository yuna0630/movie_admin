        ...
        <div class="actor_add_popup">
            <div class="actor_add_box">
                <div class="actor_info">
                    <span>배우 이름</span>
                    <input type="text" id="actor_name" value="${item.cai_name}" placeholder="배우 이름을 입력하세요(한글)">
                    <span>국적</span>
                    <input type="text" id="actor_country" value="${item.cai_country}" placeholder="국적을 입력하세요(한글)">
                </div>
        ...
        <div class="actor_list_header">
            <div class="country_area">
                ...
                <c:forEach items="${countryURL}" var="item">
                    <a href="${item.url}"
                        <c:if test="${country == item.country}">
                            class="current"
                        </c:if>
                    >${item.country}</a>
                </c:forEach>
