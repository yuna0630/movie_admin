...
$(function() {
        ...
        $.ajax({
            ...
            success:function(result) {
                ...
                $(
                    ...
                    ".movie_description_area textarea"
                ).prop("disabled", true);
            }
        })
    })
    $("#edit_basic_save").click(function(){
        ...
        $.ajax({
            ...
            success:function(r) {
                alert(r.message);
                $(".basic_info select, .basic_info input, .basic_info button, .basic_info textarea").prop("disabled", true);
                $("#edit_basic").prop("disabled", false);
            }
        })
    ...
    $(".basic_info table input, .basic_info table select").keyup(function() {
        $("#edit_basic_save").prop("disabled", false);
    })
})
